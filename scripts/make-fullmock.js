...
function main() {
  ...
  const mathsId = args.math || 'ssc_cgl_maths_15_sep_s1';
  const reasoningId = args.reasoning || 'ssc_cgl_reasoning_15_sep_s1';
  const englishId = args.english || 'ssc_cgl_eng_15_sep_s1';
  const gkId = args.gk || 'ssc_cgl_gk_15_sep_s1';
